...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container0").wowSlider({effect:"stack",prev:"",next:"",duration:20*100,delay:20*100,width:1024,height:400,autoPlay:true,autoPlayVideo:false,playPause:false,stopOnHover:false,loop:false,bullets:1,caption:true,captionEffect:"slide",controls:false,responsive:1,fullScreen:false,gestures:1,onBeforeStep:0,images:0});